...
import plusIcon from '../assets/images/plusicon-white.png';
import minusIcon from '../assets/images/minusicon-white.png';
    ...
    render() { 
        return ( 
            <div className="Footer col-12">
                <div className="Vaccine-me">
                    <button>
                        <span className="Vaccine-start">VACCINE.</span><span className="Vaccine-end">ME</span>
                    </button>
                </div>
                {
                    !this.state.isOpen ?
                ...
                <div className="col-3 SocialNetworks">
                    <img src={facebookIcon} alt="FacebookIcon" className="FacebookIcon"/>
                    <svg className="col-6" xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="white" class="bi bi-instagram" viewBox="0 0 16 16">

        ...
        return (
            ...
            {!this.state.isOpen ? 
                <div className="QAnotOpen col-12">
                    <div className="QuestionRow">
                    {
                        ...
                        this.props.q === 10 ? <span className="Question">СпутникV</span> :
                        <></>
                    }
            ...
            :
                <div className="QAOpen col-12">
                    ...
                    {
                        this.props.q === 0 ? <span className="Answer">Вакцина - самый надежный способ защитить себя и своих близких от тяжелого течения Covid-19. Ваш организм будет знаком с вирусом и в случае заражения сможет легко и быстро защитить вас. Кампания вакцинации нацелена на то, чтобы снизить циркуляцию вируса в обществе, тем самым защитить себя и тех, кто не может привиться.</span> :
                        ...
                        this.props.q === 6 ? <>
                        <span className="Answer">На данный момент по рекомендации Министра Здравоохранения любой человек может получить вакцину. Однако, есть категории лиц, которым вакцинация запрещена </span>
                        <span className="Answer"> • гиперчувствительность к какому-либо компоненту вакцины или вакцины, содержащей аналогичные компоненты;</span>
                        <span className="Answer"> • тяжелые аллергические реакции в анамнезе;</span>
                        <span className="Answer"> • беременность и период грудного вскармливания;</span>
                        <span className="Answer"> • возраст до 18 лет (в связи с отсутствием данных об эффективности и безопасности). </span>
                        <span className="Answer">Также есть противопоказания для второго компонента, если были осложнения при введении первого.  
</span>
                </> :
